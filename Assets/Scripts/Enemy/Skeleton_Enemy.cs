...
public class Skeleton_Enemy : Base_Enemy
{
    ...
    {
        return Physics2D.BoxCast(BoxCollider.bounds.center + transform.right * transform.localScale.x,
    ...
    private void OnDrawGizmos()
    {
        ...
        Gizmos.DrawWireCube(BoxCollider.bounds.center + transform.right * transform.localScale.x,
                                            new Vector3(BoxCollider.bounds.size.x * LineOfSight, BoxCollider.bounds.size.y, BoxCollider.bounds.size.z));
    }
